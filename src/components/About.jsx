...
function About() {
    return (
        <section id="about" className="min-h-screen py-20 px-8 bg-gradient-to-r from-[#f6f6d9] via-[#47e4e0] to-[#5f81e4] text-gray-900 flex flex-col md:flex-row items-center gap-10">
            <div>
                    <h2 className="text-4xl text-center font-bold mb-10">About <span className="text-blue-600">Me</span></h2>
                <div className="col-span-2 sm:px-20 px-5 justify-center">
